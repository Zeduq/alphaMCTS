...
# 1. 定义文件路径
file_paths = {
    "Group A\n(GPT-4o/En)": "result_Group_A_GPT4o_English.txt",
    "Group B\n(GPT-4o/Zh)": "result_Group_B_GPT4o_Chinese.txt",
    "Group C\n(Qwen/En)": "result_Group_C_QwenMax_English.txt",
    "Group D\n(Qwen/Zh)": "result_Group_D_QwenMax_Chinese.txt"
}
...
plt.tight_layout()
plt.savefig('factor_counts.png', dpi=300)
print("已生成: factor_counts.png (因子数量折线图)")

# --- 图表 2: Q-Value 分布 (修复 Hue 警告) ---
...
plt.xlabel('')
plt.tight_layout()
plt.savefig('q_value_distribution.png', dpi=300)
print("已生成: q_value_distribution.png")

# --- 图表 3: Rank IC 均值 (修复 Hue 警告) ---
plt.figure(figsize=(12, 6))
...
plt.tight_layout()
plt.savefig('rank_ic_comparison.png', dpi=300)
print("已生成: rank_ic_comparison.png")

# --- 图表 4: ICIR vs 换手率 (散点图) ---
...
plt.tight_layout()
plt.savefig('icir_vs_turnover.png', dpi=300)
print("已生成: icir_vs_turnover.png")

# --- 图表 5: 过拟合风险评分 (修复 Hue 警告) ---
plt.figure(figsize=(12, 6))
...
plt.xlabel('')
plt.tight_layout()
plt.savefig('overfitting_risk.png', dpi=300)
print("已生成: overfitting_risk.png")
