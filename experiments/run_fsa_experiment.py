...
from evaluation.evaluator import get_default_evaluator, simulate_evaluation
...
def calculate_library_metrics(alpha_repo: AlphaLibrary):
    ...
    calculator = get_default_evaluator().calculator
    ...
    top1_freq = 0.0
    if len(alpha_repo) > 0:
        from constraint.fsa import _extract_subtrees
