...
experiments = [
    ...
    {"name": "Group_A_GPT4o_English", "model_type": "gpt-4o", "prompt_dir": "prompts"},

    # Group B: 中文 GPT 组 (GPT-4o + 中文提示词)
    {"name": "Group_B_GPT4o_Chinese", "model_type": "gpt-4o", "prompt_dir": "prompts_cn"},

    # Group C: 英文 Qwen 组 (Qwen-Max + 英文提示词)
    {"name": "Group_C_QwenMax_English", "model_type": "qwen3-max", "prompt_dir": "prompts"},

    # Group D: 中文 Qwen 组 (Qwen-Max + 中文提示词) -> 重点关注
    {"name": "Group_D_QwenMax_Chinese", "model_type": "qwen3-max", "prompt_dir": "prompts_cn"},
]
